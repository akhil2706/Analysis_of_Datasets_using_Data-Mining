...
att1=testdata;
nb1=fitcnb(traindata(:,[1 2]),trainclass,'classNames',{'setosa','versicolor','virginica'});
tic
predclass1=predict(nb1,testdata(:,[1 2]));
toc
...
figure('Name','NAIVE BAYE''S CLASSIFICATION BASED ON ATTRIBUTE 1 & 2');
subplot(6,2,1)
...
att2=testdata;
nb2=fitcnb(traindata(:,[1 3]),trainclass,'classNames',{'setosa','versicolor','virginica'});
tic
predclass2=predict(nb2,testdata(:,[1 3]));
toc
%calculating misclassified indices
p=1;
flag=0;
...
display(loss);
%graph wrt attribute 1,2
figure('Name','NAIVE BAYE''S CLASSIFICATION BASED ON ATTRIBUTE 1 & 3');
subplot(6,2,1);
...
att3=testdata;
nb3=fitcnb(traindata(:,[1 4]),trainclass,'ClassNames',{'setosa','versicolor','virginica'});
tic
predclass3=predict(nb3,testdata(:,[1 4]));
toc
%calculating misclassified indices
l=1;
flag=0;
...
display(loss);
%graph wrt attribute 1,2
figure('Name','NAIVE BAYE''S CLASSIFICATION BASED ON ATTRIBUTE 1 & 4');
subplot(6,2,1);
...
att4=testdata;
nb4=fitcnb(traindata(:,[2 3]),trainclass,'ClassNames',{'setosa','versicolor','virginica'});
tic
predclass4=predict(nb4,testdata(:,[2 3]));
toc
%calculating misclassified indices
m=1;
flag=0;
...
display(loss);
%graph wrt attribute 1,2
figure('Name','NAIVE BAYE''S CLASSIFICATION BASED ON ATTRIBUTE 2 & 3')
subplot(6,2,1);
...
xlabel('SEPAL WIDTH (cm)','fontsize',10);
ylabel('PETAL WIDTH (cm)');
%graph wrt attribute attribute 3,4
subplot(6,2,11);
...
att5=testdata;
nb5=fitcnb(traindata(:,[2 4]),trainclass,'ClassNames',{'setosa','versicolor','virginica'});
tic
predclass5=predict(nb5,testdata(:,[2 4]));
toc
%calculating misclassified indices
n=1;
flag=0;
...
%calculating loss percentage
nbloss=(size(diff5)./size(testclass)).*100;
str15='The loss percentage is: ';
str05=num2str(nbloss(1,1));
str25=' %';
str35=strcat(str05,str25);
loss=strcat(str15,str35);
display(loss);
%graph wrt attribute 1,2
figure('Name','NAIVE BAYE''S CLASSIFICATION BASED ON ATTRIBUTE 2 & 4');
subplot(6,2,1);
...
att6=testdata;
nb6=fitcnb(traindata(:,[3 4]),trainclass,'ClassNames',{'setosa','versicolor','virginica'});
tic
predclass6=predict(nb6,testdata(:,[3 4]));
toc
...
%calculating loss percentage
nbloss=(size(diff6)./size(testclass)).*100;
str16='The loss percentage is: ';
str06=num2str(nbloss(1,1));
str26=' %';
str36=strcat(str06,str26);
loss=strcat(str16,str36);
display(loss);
%graph wrt attribute 1,2
figure('Name','NAIVE BAYE''S CLASSIFICATION BASED ON ATTRIBUTE 3 & 4');
subplot(6,2,1);
